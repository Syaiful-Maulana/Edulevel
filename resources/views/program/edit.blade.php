                ...
                <div class="row">
                    <div class="col-md-4 offset-md-4">
                        <form action="{{ url('program/' .$program->id)}}" method="POST">
                            ...
                            <div class="form-group">
                                <label>Harga Uang Gedung</label>
                                <input type="number" name="student_price" class="form-control @error('student_price') is-invalid @enderror" value="{{ old('student_price', $program->student_price) }}" autofocus>
                                @error('student_price')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                <label>Murid Maksimal</label>
                                <input type="number" name="student_max" class="form-control @error('student_max') is-invalid @enderror" value="{{ old('student_max', $program->student_max) }}" autofocus>
                                @error('student_max')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
