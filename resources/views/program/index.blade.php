                        ...
                        @foreach ($program as $key => $item)
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="{{ url('program/' .$item->id .'/edit')}}" class="btn btn-primary btn-sm">
                                        <i class="fa fa-pencil"></i>
                                    </a>
                                    <form action="{{ url('program/' .$item->id)}}" method="POST" class="d-inline" onsubmit="return confirm('Yakin hapus data?')">
